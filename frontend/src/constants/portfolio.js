...
export const PORTFOLIO_SEARCH_REQUEST = 'PORTFOLIO_SEARCH_REQUEST';
export const PORTFOLIO_SEARCH_SUCCESS = 'PORTFOLIO_SEARCH_SUCCESS';
export const PORTFOLIO_SEARCH_FAIL = 'PORTFOLIO_SEARCH_FAIL';